...
public class Controller {
	...
	//Init Methods
		...
		/**
		 * TODO
		 * Gives the caller the Singleton instance and (re)creates the object. 
	...
	//GUI triggered Methods	
		...
		/**
		 * TODO
		 * Called by GUI, when user changes their user data.
		 * method changes its actual user and notifies DBHandler of changes
		 * @param newUser Updated User item that comes from the GUI
		 */
		 ...
		 * The user will automatically get logged out and will return to the Login Screen
		 * WARNING: THIS WILL BASICALLY RESET THE WHOLE PROGRAM
		 */
		public void deleteUser() {
			//TODO es waere sicherlich ganz gut, hier noch ein paar Unterfunktionen zu bauen
			//TODO GUI schliessen
		...
		/**
		 * TODO
		 * Position in DBHandler speichern
		 */
	...
	//Getters
		...
		public Category[] getMainCategoryList() {
